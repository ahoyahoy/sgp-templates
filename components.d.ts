...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    CloseButton: typeof import('./src/components/primitives/close-button.vue')['default']
    CloseIcon: typeof import('./src/components/icons/close-icon.vue')['default']
    copy: typeof import('./src/components/primitives/select-box copy.vue')['default']
    DataList: typeof import('./src/components/advanced/data-list.vue')['default']
    DotsButton: typeof import('./src/components/primitives/dots-button.vue')['default']
